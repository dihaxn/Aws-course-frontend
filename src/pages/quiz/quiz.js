...
export default function (props) {
    ...
    const submitAnswer = () => {
            axios({
                url:`https://game.zeusis.org/api/v1/game/answer/check`,
                method:'POST',
        ...
        <div className="quiz-cover">
            ...
            <ArrowLeftCircle size={28} />
                ...
                <div className={"w-50 mt-3"}>
                    ...
                    <img className={'mt-2 quiz-img'} style={{width:'100%',height:'380px'}} src={url ? url : `https://www.sanfoh.com/uob/smile/data/sb8c05af345eb7fad2aed276a12n704.png`}/>
